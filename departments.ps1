...
foreach ($company in $companies)
{
    ...
    $uri = 'https://api.businesscentral.dynamics.com/v2.0/95806b3e-1cff-4894-8beb-f0b0302988a0/Production/api/swisssalary/swisssalary365/v1.0/companies(' + $company_id + ')/departments'
